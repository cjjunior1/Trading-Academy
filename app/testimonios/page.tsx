...
const testimonials = [
  {
    ...
    content: "Después de perder más de $15,000 dólares probando diferentes estrategias por mi cuenta, encontré Trading Academy. El método es completamente diferente a todo lo que había visto. En 6 meses no solo recuperé mi inversión, sino que ahora genero un ingreso constante que me permite trabajar menos horas en mi negocio.",
    profit: "+$8,500",
    period: "6 meses",
  ...
  },
  {
    ...
    role: "Emprendedora",
    country: "Argentina",
    image: "https://cdn.abacus.ai/images/8886c8ce-491d-4519-a4c7-3fa463787f89.png",
...
const stats = [
  ...
  { value: "$2.5M+", label: "Ganancias generadas" },
