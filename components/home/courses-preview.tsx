...
const courses = [
  {
    ...
    features: ["Análisis técnico básico", "Gestión de riesgo", "Plataformas de trading"],
    students: "850+",
    duration: "4 semanas",
    rating: 4.8,
  },
  {
    ...
    features: ["Patrones de velas", "Indicadores técnicos", "Psicología del trader"],
    students: "520+",
    duration: "6 semanas",
    rating: 4.9,
    popular: true,
  },
  {
    ...
    features: ["Análisis institucional", "Automatización", "Mentoría 1:1"],
    students: "180+",
    duration: "12 semanas",
    rating: 5.0,
  },
