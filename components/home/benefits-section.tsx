...
const benefits = [
  ...
  },
  {
    ...
    description: "Compra una vez, accede siempre. Incluye todas las actualizaciones",
    color: "text-emerald-400",
    bg: "bg-emerald-500/10",
  },
  {
  ...
  },
  {
    icon: Award,
    title: "Certificación",
    description: "Obtén tu certificado al completar cada nivel del programa",
    color: "text-amber-400",
    bg: "bg-amber-500/10",
  },
];
    ...
    <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950" ref={ref}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          >
            ¿Por qué elegir <span className="gradient-text">Trading Academy</span>?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
